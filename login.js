...
(function () {
  ...
  const permisos = window.ETPermissions
    ...
    : {
        SuperAdmin: ["Dashboard", "Parque Vehicular", "Acuerdos", "Peticiones", "Requisiciones", "Seguimiento SIIF", "Requisiciones SIIF", "Órdenes de Compra SIIF", "Solicitudes de Pago SIIF", "Importar SIIF", "Vales", "Usuarios", "Auditoría", "Tiempo Extra", "Generar Textos"],
        Admin: ["Dashboard", "Parque Vehicular", "Acuerdos", "Peticiones", "Requisiciones", "Seguimiento SIIF", "Requisiciones SIIF", "Órdenes de Compra SIIF", "Solicitudes de Pago SIIF", "Importar SIIF", "Vales", "Auditoría", "Tiempo Extra", "Generar Textos"],
        "Moderador de Acuerdos": ["Dashboard", "Acuerdos"],
        Compras: ["Dashboard", "Peticiones", "Requisiciones", "Seguimiento SIIF", "Requisiciones SIIF", "Órdenes de Compra SIIF", "Solicitudes de Pago SIIF", "Importar SIIF", "Generar Textos"],
        ...
        Consulta: ["Dashboard", "Parque Vehicular", "Peticiones", "Requisiciones", "Seguimiento SIIF", "Vales"],
